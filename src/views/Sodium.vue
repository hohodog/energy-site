<template>
  <section class="tech-page section-wrap">
    <header class="card hero">
      ...
      <h1>Sodium-ion Batteries</h1>
      <p>Balanced cost, robust temperature tolerance and growing relevance for stationary storage.</p>
    </header>
    ...
    <section class="grid">
      <article class="card">
        ...
        <ul>
          <li>C&I peak shaving with moderate footprint constraints</li>
          <li>Cold-climate deployments requiring stable discharge behavior</li>
          <li>Projects seeking material supply diversification</li>
        </ul>
      </article>
      ...
      <article class="card">
        ...
        <ul>
          <li>Cell consistency across batches</li>
          <li>BMS strategy for temperature windows</li>
          <li>Cycle-life assumptions under partial-state operation</li>
        </ul>
      </article>
    </section>
  </section>
