<template>
  <section class="tech-page section-wrap">
    <header class="card hero">
      ...
      <h1>Supercapacitors</h1>
      <p>Ultra-fast response and extreme cycle life for power-quality and transient support applications.</p>
    </header>
    ...
    <section class="grid">
      <article class="card">
        ...
        <ul>
          ...
          <li>Short-duration bridge power for sensitive loads</li>
          <li>Hybrid systems paired with batteries for peak pulses</li>
        </ul>
      </article>
      ...
      <article class="card">
        ...
        <ul>
          <li>Energy capacity limitations for long discharge windows</li>
          <li>Thermal and enclosure design at high power rates</li>
          <li>Control strategy in hybrid ESS architectures</li>
        </ul>
      </article>
    </section>
  </section>
